  ...
  return (
    <>
      <div className="mx-auto max-w-2xl">
        ...
        />
        <HeaderSection
          label="AI-Powered CV Preparation"
          title="Build a Standout CV in Minutes with Smart Tools"
          subtitle="Join thousands of job seekers and create your professional CV quickly and easily."
        />
      </div>
            ...
            <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2">
              <div className="relative m-auto size-fit">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  95% of users found their CV creation process easier and faster
                  with CV Path.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative z-10 mt-8 space-y-1.5 text-center">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    to make your CV stand out to recruiters.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
              <div>
                ...
                <div className="relative z-10 mt-8 space-y-1.5 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Download your CV as PDF or share it instantly with a unique
                    online link.
                  </p>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Add, remove, or reorder sections like Skills, Experience,
                      and Education to fit your needs.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid h-full sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Your data is safe. Only you control who can view or
                      download your CV.
                    </p>
                  </div>
                </div>
